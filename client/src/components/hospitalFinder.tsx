  ...
  return (
    <Card className="shadow-lg medical-card">
      <CardHeader className="border-b border-border">
        ...
        <p className="text-muted-foreground">Find the best nearby locations for care</p>
      </CardHeader>
      ...
      <CardContent className="p-6">
        ...
        {recommended && (
          <div className="mt-6 p-4 bg-green-100 border border-green-300 rounded-lg shadow">
            <h3 className="font-bold text-lg mb-1">Recommended Hospital</h3>
            <p className="font-semibold">{recommended.name}</p>
            <p className="text-sm">Distance: {recommended.distance.toFixed(2)} km</p>
            <p className="text-sm">ETA: {estimateETA(recommended.distance)}</p>

            <Button
              onClick={() => navigateToHospital(recommended)}
              className="mt-3 w-full md:w-1/3 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-primary-foreground font-semibold py-3 shadow-lg transition-all duration-200 transform hover:scale-105"
            >
              Directions
            </Button>
          </div>
          ...
          {hospitals.map((h: any, i: number) => (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  <p className="text-sm font-medium text-primary">{h.distance.toFixed(2)} km</p>
              ...
              {selectedHospitalIndex === i && (
                <Button
                  ...
                  className="mt-4 w-full md:w-1/3 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-primary-foreground font-semibold py-3 shadow-lg transition-all duration-200 transform hover:scale-105"
                >
                  Directions
                </Button>
              )}
